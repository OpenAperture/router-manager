defmodule RouterManager.Api.RouteController do
  require Logger
  ...
  # GET "/api/authorities/:parent_id/routes?hostspec=[:hostname]:[:port]"
  ...
  # GET "/api/authorities/:parent_id/routes"
  ...
  # DELETE "/api/authorities/:parent_id/routes/clear"
  ...
  # DELETE "/api/authorities/:parent_id/routes/:id"
  ...
  # POST "/api/authorities/:parent_id/routes"
  def create(conn, %{"parent_id" => authority_id, "hostname" => hostname, "port" => port} = params) do
    ...
    case Repo.one(query) do
      ...
      {_host, existing_route} when existing_route != nil ->
        resp(conn, :conflict, "")
      {authority, nil} ->
        changeset = Route.changeset(%Route{authority_id: authority_id}, params)
        if changeset.valid? do
          ...
          case result do
            {:ok, route} ->
              path = api_route_path(Endpoint, :show, authority.id, route.id)
              conn
  ...
  # PUT/PATCH "/api/authorities/:authority_id/routes/:id"
